...
import heroImg from '../assets/galeneImage1.jpg';
import Button from './ui/Button';
import { HERO_CONTENT } from '../data/content';

const Hero = () => (
  <header id="inicio" className="relative pt-40 pb-20 lg:pt-40 lg:pb-32 bg-light overflow-hidden">
    ...
    <div className="container mx-auto px-z">
