            ...
            <div className="flex gap-8 testimonial-marquee">
              {marqueeReviews.map((review, idx) => (
                <article
                  ...
                  className="bg-slate-50 p-10 rounded-2xl relative shadow-sm border border-slate-100 shrink-0 flex flex-col gap-3 w-[280px] h-[280px] sm:w-[300px] sm:h-[300px] lg:w-[500px] lg:h-[280px]"
                >
